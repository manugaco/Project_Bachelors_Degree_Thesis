...
S1_2017_12_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/12/S1_2017_12_21.csv", 
                       ";", escape_double = FALSE, trim_ws = TRUE)))

S1_2017_12_21 <- select(S1_2017_12_21, c("username", "date", "text"))

S2_2017_12_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/12/S2_2017_12_21.csv", 
                           ";", escape_double = FALSE, trim_ws = TRUE)))

S2_2017_12_21 <- select(S2_2017_12_21, c("username", "date", "text"))

S3_2017_12_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/12/S3_2017_12_21.csv", 
                           ";", escape_double = FALSE, trim_ws = TRUE)))

S3_2017_12_21 <- select(S3_2017_12_21, c("username", "date", "text"))

DF_2017_12_21 <- rbind(S1_2017_12_21, S2_2017_12_21, S3_2017_12_21)

save(DF_2017_12_21, file = "Objects/Tweets/Series_21/Dirty/DF_2017_12_21.RData")

vector <- as.vector(DF_2017_12_21$text)

fun_txtcleaner(vector)

DF_2017_12_21_cleanREG <- clean_REG
DF_2017_12_21_cleanESP <- clean_ESP

save(DF_2017_12_21_cleanREG, file = "Objects/Tweets/Series_21/Clean/REG/DF_2017_12_21.RData")
save(DF_2017_12_21_cleanESP, file = "Objects/Tweets/Series_21/Clean/ESP/DF_2017_12_21.RData")

rm(S1_2017_12_21, S2_2017_12_21, S3_2017_12_21, DF_2017_12_21, DF_2017_12_21_cleanREG, DF_2017_12_21_cleanESP, clean_ESP, clean_REG, vector)
...
S1_2017_11_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/11/S1_2017_11_21.csv", 
                           ";", escape_double = FALSE, trim_ws = TRUE)))

S1_2017_11_21 <- select(S1_2017_11_21, c("username", "date", "retweets", "favorites", "text"))

S2_2017_11_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/11/S2_2017_11_21.csv", 
                           ";", escape_double = FALSE, trim_ws = TRUE)))

S2_2017_11_21 <- select(S2_2017_11_21, c("username", "date", "retweets", "favorites", "text"))

S3_2017_11_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/11/S3_2017_11_21.csv", 
                           ";", escape_double = FALSE, trim_ws = TRUE)))

S3_2017_11_21 <- select(S3_2017_11_21, c("username", "date", "retweets", "favorites", "text"))

DF_2017_11_21 <- rbind(S1_2017_11_21, S2_2017_11_21, S3_2017_11_21)

save(DF_2017_11_21, file = "Objects/Tweets/Series_21/Dirty/DF_2017_11_21.RData")

vector <- as.vector(DF_2017_11_21$text)

fun_txtcleaner(vector)

DF_2017_11_21_cleanREG <- clean_REG
DF_2017_11_21_cleanESP <- clean_ESP

save(DF_2017_11_21_cleanREG, file = "Objects/Tweets/Series_21/Clean/REG/DF_2017_11_21.RData")
save(DF_2017_11_21_cleanESP, file = "Objects/Tweets/Series_21/Clean/ESP/DF_2017_11_21.RData")

rm(S1_2017_11_21, S2_2017_11_21, S3_2017_11_21, DF_2017_11_21, DF_2017_11_21_cleanREG, DF_2017_11_21_cleanESP, clean_ESP, clean_REG, vector)
...
S1_2017_10_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/10/S1_2017_10_21.csv", 
                           ";", escape_double = FALSE, trim_ws = TRUE)))

S1_2017_10_21 <- select(S1_2017_10_21, c("username", "date", "retweets", "favorites", "text"))

S2_2017_10_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/10/S2_2017_10_21.csv", 
                           ";", escape_double = FALSE, trim_ws = TRUE)))

S2_2017_10_21 <- select(S2_2017_10_21, c("username", "date", "retweets", "favorites", "text"))

S3_2017_10_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/10/S3_2017_10_21.csv", 
                           ";", escape_double = FALSE, trim_ws = TRUE)))

S3_2017_10_21 <- select(S3_2017_10_21, c("username", "date", "retweets", "favorites", "text"))

DF_2017_10_21 <- rbind(S1_2017_10_21, S2_2017_10_21, S3_2017_10_21)

save(DF_2017_10_21, file = "Objects/Tweets/Series_21/Dirty/DF_2017_10_21.RData")

vector <- as.vector(DF_2017_10_21$text)

fun_txtcleaner(vector)

DF_2017_10_21_cleanREG <- clean_REG
DF_2017_10_21_cleanESP <- clean_ESP

save(DF_2017_10_21_cleanREG, file = "Objects/Tweets/Series_21/Clean/REG/DF_2017_10_21.RData")
save(DF_2017_10_21_cleanESP, file = "Objects/Tweets/Series_21/Clean/ESP/DF_2017_10_21.RData")

rm(S1_2017_10_21, S2_2017_10_21, S3_2017_10_21, DF_2017_10_21, DF_2017_10_21_cleanREG, DF_2017_10_21_cleanESP, clean_ESP, clean_REG, vector)
...
S1_2017_9_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/9/S1_2017_9_21.csv", 
                           ";", escape_double = FALSE, trim_ws = TRUE)))

S1_2017_9_21 <- select(S1_2017_9_21, c("username", "date", "retweets", "favorites", "text"))

S2_2017_9_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/9/S2_2017_9_21.csv", 
                           ";", escape_double = FALSE, trim_ws = TRUE)))

S2_2017_9_21 <- select(S2_2017_9_21, c("username", "date", "retweets", "favorites", "text"))

S3_2017_9_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/9/S3_2017_9_21.csv", 
                           ";", escape_double = FALSE, trim_ws = TRUE)))

S3_2017_9_21 <- select(S3_2017_9_21, c("username", "date", "retweets", "favorites", "text"))

DF_2017_9_21 <- rbind(S1_2017_9_21, S2_2017_9_21, S3_2017_9_21)

save(DF_2017_9_21, file = "Objects/Tweets/Series_21/Dirty/DF_2017_9_21.RData")

vector <- as.vector(DF_2017_9_21$text)

fun_txtcleaner(vector)

DF_2017_9_21_cleanREG <- clean_REG
DF_2017_9_21_cleanESP <- clean_ESP

save(DF_2017_9_21_cleanREG, file = "Objects/Tweets/Series_21/Clean/REG/DF_2017_9_21.RData")
save(DF_2017_9_21_cleanESP, file = "Objects/Tweets/Series_21/Clean/ESP/DF_2017_9_21.RData")

rm(S1_2017_9_21, S2_2017_9_21, S3_2017_9_21, DF_2017_9_21, DF_2017_9_21_cleanREG, DF_2017_9_21_cleanESP, clean_ESP, clean_REG, vector)
...
S1_2017_8_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/8/S1_2017_8_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S1_2017_8_21 <- select(S1_2017_8_21, c("username", "date", "retweets", "favorites", "text"))

S2_2017_8_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/8/S2_2017_8_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S2_2017_8_21 <- select(S2_2017_8_21, c("username", "date", "retweets", "favorites", "text"))

S3_2017_8_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/8/S3_2017_8_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S3_2017_8_21 <- select(S3_2017_8_21, c("username", "date", "retweets", "favorites", "text"))

DF_2017_8_21 <- rbind(S1_2017_8_21, S2_2017_8_21, S3_2017_8_21)

save(DF_2017_8_21, file = "Objects/Tweets/Series_21/Dirty/DF_2017_8_21.RData")

vector <- as.vector(DF_2017_8_21$text)

fun_txtcleaner(vector)

DF_2017_8_21_cleanREG <- clean_REG
DF_2017_8_21_cleanESP <- clean_ESP

save(DF_2017_8_21_cleanREG, file = "Objects/Tweets/Series_21/Clean/REG/DF_2017_8_21.RData")
save(DF_2017_8_21_cleanESP, file = "Objects/Tweets/Series_21/Clean/ESP/DF_2017_8_21.RData")

rm(S1_2017_8_21, S2_2017_8_21, S3_2017_8_21, DF_2017_8_21, DF_2017_8_21_cleanREG, DF_2017_8_21_cleanESP, clean_ESP, clean_REG, vector)
...
S1_2017_7_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/7/S1_2017_7_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S1_2017_7_21 <- select(S1_2017_7_21, c("username", "date", "retweets", "favorites", "text"))

S2_2017_7_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/7/S2_2017_7_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S2_2017_7_21 <- select(S2_2017_7_21, c("username", "date", "retweets", "favorites", "text"))

S3_2017_7_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/7/S3_2017_7_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S3_2017_7_21 <- select(S3_2017_7_21, c("username", "date", "retweets", "favorites", "text"))

DF_2017_7_21 <- rbind(S1_2017_7_21, S2_2017_7_21, S3_2017_7_21)

save(DF_2017_7_21, file = "Objects/Tweets/Series_21/Dirty/DF_2017_7_21.RData")

vector <- as.vector(DF_2017_7_21$text)

fun_txtcleaner(vector)

DF_2017_7_21_cleanREG <- clean_REG
DF_2017_7_21_cleanESP <- clean_ESP

save(DF_2017_7_21_cleanREG, file = "Objects/Tweets/Series_21/Clean/REG/DF_2017_7_21.RData")
save(DF_2017_7_21_cleanESP, file = "Objects/Tweets/Series_21/Clean/ESP/DF_2017_7_21.RData")

rm(S1_2017_7_21, S2_2017_7_21, S3_2017_7_21, DF_2017_7_21, DF_2017_7_21_cleanREG, DF_2017_7_21_cleanESP, clean_ESP, clean_REG, vector)
...
S1_2017_6_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/6/S1_2017_6_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S1_2017_6_21 <- select(S1_2017_6_21, c("username", "date", "retweets", "favorites", "text"))

S2_2017_6_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/6/S2_2017_6_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S2_2017_6_21 <- select(S2_2017_6_21, c("username", "date", "retweets", "favorites", "text"))

S3_2017_6_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/6/S3_2017_6_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S3_2017_6_21 <- select(S3_2017_6_21, c("username", "date", "retweets", "favorites", "text"))

DF_2017_6_21 <- rbind(S1_2017_6_21, S2_2017_6_21, S3_2017_6_21)

save(DF_2017_6_21, file = "Objects/Tweets/Series_21/Dirty/DF_2017_6_21.RData")

vector <- as.vector(DF_2017_6_21$text)

fun_txtcleaner(vector)

DF_2017_6_21_cleanREG <- clean_REG
DF_2017_6_21_cleanESP <- clean_ESP

save(DF_2017_6_21_cleanREG, file = "Objects/Tweets/Series_21/Clean/REG/DF_2017_6_21.RData")
save(DF_2017_6_21_cleanESP, file = "Objects/Tweets/Series_21/Clean/ESP/DF_2017_6_21.RData")

rm(S1_2017_6_21, S2_2017_6_21, S3_2017_6_21, DF_2017_6_21, DF_2017_6_21_cleanREG, DF_2017_6_21_cleanESP, clean_ESP, clean_REG, vector)
...
S1_2017_5_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/5/S1_2017_5_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S1_2017_5_21 <- select(S1_2017_5_21, c("username", "date", "retweets", "favorites", "text"))

S2_2017_5_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/5/S2_2017_5_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S2_2017_5_21 <- select(S2_2017_5_21, c("username", "date", "retweets", "favorites", "text"))

S3_2017_5_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/5/S3_2017_5_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S3_2017_5_21 <- select(S3_2017_5_21, c("username", "date", "retweets", "favorites", "text"))

DF_2017_5_21 <- rbind(S1_2017_5_21, S2_2017_5_21, S3_2017_5_21)

save(DF_2017_5_21, file = "Objects/Tweets/Series_21/Dirty/DF_2017_5_21.RData")

vector <- as.vector(DF_2017_5_21$text)

fun_txtcleaner(vector)

DF_2017_5_21_cleanREG <- clean_REG
DF_2017_5_21_cleanESP <- clean_ESP

save(DF_2017_5_21_cleanREG, file = "Objects/Tweets/Series_21/Clean/REG/DF_2017_5_21.RData")
save(DF_2017_5_21_cleanESP, file = "Objects/Tweets/Series_21/Clean/ESP/DF_2017_5_21.RData")

rm(S1_2017_5_21, S2_2017_5_21, S3_2017_5_21, DF_2017_5_21, DF_2017_5_21_cleanREG, DF_2017_5_21_cleanESP, clean_ESP, clean_REG, vector)
...
S1_2017_4_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/4/S1_2017_4_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S1_2017_4_21 <- select(S1_2017_4_21, c("username", "date", "retweets", "favorites", "text"))

S2_2017_4_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/4/S2_2017_4_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S2_2017_4_21 <- select(S2_2017_4_21, c("username", "date", "retweets", "favorites", "text"))

S3_2017_4_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/4/S3_2017_4_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S3_2017_4_21 <- select(S3_2017_4_21, c("username", "date", "retweets", "favorites", "text"))

DF_2017_4_21 <- rbind(S1_2017_4_21, S2_2017_4_21, S3_2017_4_21)

save(DF_2017_4_21, file = "Objects/Tweets/Series_21/Dirty/DF_2017_4_21.RData")

vector <- as.vector(DF_2017_4_21$text)

fun_txtcleaner(vector)

DF_2017_4_21_cleanREG <- clean_REG
DF_2017_4_21_cleanESP <- clean_ESP

save(DF_2017_4_21_cleanREG, file = "Objects/Tweets/Series_21/Clean/REG/DF_2017_4_21.RData")
save(DF_2017_4_21_cleanESP, file = "Objects/Tweets/Series_21/Clean/ESP/DF_2017_4_21.RData")

rm(S1_2017_4_21, S2_2017_4_21, S3_2017_4_21, DF_2017_4_21, DF_2017_4_21_cleanREG, DF_2017_4_21_cleanESP, clean_ESP, clean_REG, vector)
...
S1_2017_3_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/3/S1_2017_3_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S1_2017_3_21 <- select(S1_2017_3_21, c("username", "date", "retweets", "favorites", "text"))

S2_2017_3_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/3/S2_2017_3_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S2_2017_3_21 <- select(S2_2017_3_21, c("username", "date", "retweets", "favorites", "text"))

S3_2017_3_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/3/S3_2017_3_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S3_2017_3_21 <- select(S3_2017_3_21, c("username", "date", "retweets", "favorites", "text"))

DF_2017_3_21 <- rbind(S1_2017_3_21, S2_2017_3_21, S3_2017_3_21)

save(DF_2017_3_21, file = "Objects/Tweets/Series_21/Dirty/DF_2017_3_21.RData")

vector <- as.vector(DF_2017_3_21$text)

fun_txtcleaner(vector)

DF_2017_3_21_cleanREG <- clean_REG
DF_2017_3_21_cleanESP <- clean_ESP

save(DF_2017_3_21_cleanREG, file = "Objects/Tweets/Series_21/Clean/REG/DF_2017_3_21.RData")
save(DF_2017_3_21_cleanESP, file = "Objects/Tweets/Series_21/Clean/ESP/DF_2017_3_21.RData")

rm(S1_2017_3_21, S2_2017_3_21, S3_2017_3_21, DF_2017_3_21, DF_2017_3_21_cleanREG, DF_2017_3_21_cleanESP, clean_ESP, clean_REG, vector)
...
S1_2017_2_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/2/S1_2017_2_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S1_2017_2_21 <- select(S1_2017_2_21, c("username", "date", "retweets", "favorites", "text"))

S2_2017_2_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/2/S2_2017_2_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S2_2017_2_21 <- select(S2_2017_2_21, c("username", "date", "retweets", "favorites", "text"))

S3_2017_2_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/2/S3_2017_2_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S3_2017_2_21 <- select(S3_2017_2_21, c("username", "date", "retweets", "favorites", "text"))

DF_2017_2_21 <- rbind(S1_2017_2_21, S2_2017_2_21, S3_2017_2_21)

save(DF_2017_2_21, file = "Objects/Tweets/Series_21/Dirty/DF_2017_2_21.RData")

vector <- as.vector(DF_2017_2_21$text)

fun_txtcleaner(vector)

DF_2017_2_21_cleanREG <- clean_REG
DF_2017_2_21_cleanESP <- clean_ESP

save(DF_2017_2_21_cleanREG, file = "Objects/Tweets/Series_21/Clean/REG/DF_2017_2_21.RData")
save(DF_2017_2_21_cleanESP, file = "Objects/Tweets/Series_21/Clean/ESP/DF_2017_2_21.RData")

rm(S1_2017_2_21, S2_2017_2_21, S3_2017_2_21, DF_2017_2_21, DF_2017_2_21_cleanREG, DF_2017_2_21_cleanESP, clean_ESP, clean_REG, vector)
...
S1_2017_1_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/1/S1_2017_1_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S1_2017_1_21 <- select(S1_2017_1_21, c("username", "date", "retweets", "favorites", "text"))

S2_2017_1_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/1/S2_2017_1_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S2_2017_1_21 <- select(S2_2017_1_21, c("username", "date", "retweets", "favorites", "text"))

S3_2017_1_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2017/1/S3_2017_1_21.csv", 
                          ";", escape_double = FALSE, trim_ws = TRUE)))

S3_2017_1_21 <- select(S3_2017_1_21, c("username", "date", "retweets", "favorites", "text"))

DF_2017_1_21 <- rbind(S1_2017_1_21, S2_2017_1_21, S3_2017_1_21)

save(DF_2017_1_21, file = "Objects/Tweets/Series_21/Dirty/DF_2017_1_21.RData")

vector <- as.vector(DF_2017_1_21$text)

fun_txtcleaner(vector)

DF_2017_1_21_cleanREG <- clean_REG
DF_2017_1_21_cleanESP <- clean_ESP

save(DF_2017_1_21_cleanREG, file = "Objects/Tweets/Series_21/Clean/REG/DF_2017_1_21.RData")
save(DF_2017_1_21_cleanESP, file = "Objects/Tweets/Series_21/Clean/ESP/DF_2017_1_21.RData")

rm(S1_2017_1_21, S2_2017_1_21, S3_2017_1_21, DF_2017_1_21, DF_2017_1_21_cleanREG, DF_2017_1_21_cleanESP, clean_ESP, clean_REG, vector)
...
S1_2016_12_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2016/12/S1_2016_12_21.csv", 
                            ";", escape_double = FALSE, trim_ws = TRUE)))

S1_2016_12_21 <- select(S1_2016_12_21, c("username", "date", "text"))

S2_2016_12_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2016/12/S2_2016_12_21.csv", 
                            ";", escape_double = FALSE, trim_ws = TRUE)))

S2_2016_12_21 <- select(S2_2016_12_21, c("username", "date", "text"))

S3_2016_12_21 <- suppressMessages(suppressWarnings(read_delim("~/Desktop/TFG/Datasets/Tweets/Series_21/2016/12/S3_2016_12_21.csv", 
                            ";", escape_double = FALSE, trim_ws = TRUE)))

S3_2016_12_21 <- select(S3_2016_12_21, c("username", "date", "text"))

DF_2016_12_21 <- rbind(S1_2016_12_21, S2_2016_12_21, S3_2016_12_21)

save(DF_2016_12_21, file = "Objects/Tweets/Series_21/Dirty/DF_2016_12_21.RData")

vector <- as.vector(DF_2016_12_21$text)

fun_txtcleaner(vector)

DF_2016_12_21_cleanREG <- clean_REG
DF_2016_12_21_cleanESP <- clean_ESP

save(DF_2016_12_21_cleanREG, file = "Objects/Tweets/Series_21/Clean/REG/DF_2016_12_21.RData")
save(DF_2016_12_21_cleanESP, file = "Objects/Tweets/Series_21/Clean/ESP/DF_2016_12_21.RData")

rm(S1_2016_12_21, S2_2016_12_21, S3_2016_12_21, DF_2016_12_21, DF_2016_12_21_cleanREG, DF_2016_12_21_cleanESP, clean_ESP, clean_REG, vector)
