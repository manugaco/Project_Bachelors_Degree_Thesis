...
cortab <- table_cell_font(cortab, row = 3, column = 5,
                       face = "bold")
cortab <- table_cell_bg(cortab, row = 3, column = 5, linewidth = 5,
                     fill="darkolivegreen1", color = "darkolivegreen4")

cortab <- table_cell_font(cortab, row = 5, column = 3,
                          face = "bold")
cortab <- table_cell_bg(cortab, row = 5, column = 3, linewidth = 5,
                        fill="darkolivegreen1", color = "darkolivegreen4")
