...
stable0 <- cbind(stableICC, stableISA, stableIEE, stableICC1, stableISA1, 
                 stableIEE1, stableICC2, stableISA2, stableIEE2, stableall, stableeco)

colnames(stable0) <- c("ICC", "ISA", "IEE", "ICC1", "ISA1", "IEE1", "ICC2", "ISA2", "IEE2", "SSI", "SSIF")
...
colnames(DF_maincorr) <- c("SSI","SSIF", "ICC", "ISA", "IEE", "ICC(t-1)", "ISA(t-1)",
