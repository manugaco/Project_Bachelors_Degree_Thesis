...
dataset24 <- read_excel("Datasets/Series/SSMI.xlsx")
load(file = "Objects/Models/resultsF24.RData")

DF_results <- cbind(dataset24, results24)
...
write.xlsx(DF_results, file="Datasets/Series/DF_results24.xlsx")
