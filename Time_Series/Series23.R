...
dataset23 <- read_excel("Datasets/Series/SSMI.xlsx")
load(file = "Objects/Models/resultsF23.RData")

DF_results <- cbind(dataset23, results23)
...
write.xlsx(DF_results, file="Datasets/Series/DF_results23.xlsx")
