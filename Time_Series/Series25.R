...
dataset25 <- read_excel("Datasets/Series/SSMI.xlsx")
load(file = "Objects/Models/resultsF25.RData")

DF_results <- cbind(dataset25, results25)
...
write.xlsx(DF_results, file="Datasets/Series/DF_results25.xlsx")
