...
scores <- score.sentiment(DF_2017_12_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2017_12_21$sentiment[DF_2017_12_21$sentiment < 0] <- "0"
DF_2017_12_21$sentiment[DF_2017_12_21$sentiment > 0] <- "1"
...
results21L2F <- results2017_12_21
...
scores <- score.sentiment(DF_2017_11_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2017_11_21$sentiment[DF_2017_11_21$sentiment < 0] <- "0"
DF_2017_11_21$sentiment[DF_2017_11_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2017_11_21)
...
scores <- score.sentiment(DF_2017_10_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2017_10_21$sentiment[DF_2017_10_21$sentiment < 0] <- "0"
DF_2017_10_21$sentiment[DF_2017_10_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2017_10_21)
...
scores <- score.sentiment(DF_2017_9_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2017_9_21$sentiment[DF_2017_9_21$sentiment < 0] <- "0"
DF_2017_9_21$sentiment[DF_2017_9_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2017_9_21)
...
scores <- score.sentiment(DF_2017_8_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2017_8_21$sentiment[DF_2017_8_21$sentiment < 0] <- "0"
DF_2017_8_21$sentiment[DF_2017_8_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2017_8_21)
...
scores <- score.sentiment(DF_2017_7_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2017_7_21$sentiment[DF_2017_7_21$sentiment < 0] <- "0"
DF_2017_7_21$sentiment[DF_2017_7_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2017_7_21)
...
scores <- score.sentiment(DF_2017_6_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2017_6_21$sentiment[DF_2017_6_21$sentiment < 0] <- "0"
DF_2017_6_21$sentiment[DF_2017_6_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2017_6_21)
...
scores <- score.sentiment(DF_2017_5_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2017_5_21$sentiment[DF_2017_5_21$sentiment < 0] <- "0"
DF_2017_5_21$sentiment[DF_2017_5_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2017_5_21)
...
scores <- score.sentiment(DF_2017_4_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2017_4_21$sentiment[DF_2017_4_21$sentiment < 0] <- "0"
DF_2017_4_21$sentiment[DF_2017_4_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2017_4_21)
...
scores <- score.sentiment(DF_2017_3_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2017_3_21$sentiment[DF_2017_3_21$sentiment < 0] <- "0"
DF_2017_3_21$sentiment[DF_2017_3_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2017_3_21)
...
scores <- score.sentiment(DF_2017_2_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2017_2_21$sentiment[DF_2017_2_21$sentiment < 0] <- "0"
DF_2017_2_21$sentiment[DF_2017_2_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2017_2_21)
...
scores <- score.sentiment(DF_2017_1_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2017_1_21$sentiment[DF_2017_1_21$sentiment < 0] <- "0"
DF_2017_1_21$sentiment[DF_2017_1_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2017_1_21)
...
scores <- score.sentiment(DF_2016_12_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2016_12_21$sentiment[DF_2016_12_21$sentiment < 0] <- "0"
DF_2016_12_21$sentiment[DF_2016_12_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2016_12_21)
...
scores <- score.sentiment(DF_2016_11_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2016_11_21$sentiment[DF_2016_11_21$sentiment < 0] <- "0"
DF_2016_11_21$sentiment[DF_2016_11_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2016_11_21)
...
scores <- score.sentiment(DF_2016_10_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2016_10_21$sentiment[DF_2016_10_21$sentiment < 0] <- "0"
DF_2016_10_21$sentiment[DF_2016_10_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2016_10_21)
...
scores <- score.sentiment(DF_2016_9_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2016_9_21$sentiment[DF_2016_9_21$sentiment < 0] <- "0"
DF_2016_9_21$sentiment[DF_2016_9_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2016_9_21)
...
scores <- score.sentiment(DF_2016_8_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2016_8_21$sentiment[DF_2016_8_21$sentiment < 0] <- "0"
DF_2016_8_21$sentiment[DF_2016_8_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2016_8_21)
...
scores <- score.sentiment(DF_2016_7_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2016_7_21$sentiment[DF_2016_7_21$sentiment < 0] <- "0"
DF_2016_7_21$sentiment[DF_2016_7_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2016_7_21)
...
scores <- score.sentiment(DF_2016_6_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2016_6_21$sentiment[DF_2016_6_21$sentiment < 0] <- "0"
DF_2016_6_21$sentiment[DF_2016_6_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2016_6_21)
...
scores <- score.sentiment(DF_2016_5_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2016_5_21$sentiment[DF_2016_5_21$sentiment < 0] <- "0"
DF_2016_5_21$sentiment[DF_2016_5_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2016_5_21)
...
scores <- score.sentiment(DF_2016_4_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2016_4_21$sentiment[DF_2016_4_21$sentiment < 0] <- "0"
DF_2016_4_21$sentiment[DF_2016_4_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2016_4_21)
...
scores <- score.sentiment(DF_2016_3_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2016_3_21$sentiment[DF_2016_3_21$sentiment < 0] <- "0"
DF_2016_3_21$sentiment[DF_2016_3_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2016_3_21)
...
scores <- score.sentiment(DF_2016_2_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2016_2_21$sentiment[DF_2016_2_21$sentiment < 0] <- "0"
DF_2016_2_21$sentiment[DF_2016_2_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2016_2_21)
...
scores <- score.sentiment(DF_2016_1_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2016_1_21$sentiment[DF_2016_1_21$sentiment < 0] <- "0"
DF_2016_1_21$sentiment[DF_2016_1_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2016_1_21)
...
scores <- score.sentiment(DF_2015_12_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2015_12_21$sentiment[DF_2015_12_21$sentiment < 0] <- "0"
DF_2015_12_21$sentiment[DF_2015_12_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2015_12_21)
...
scores <- score.sentiment(DF_2015_11_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2015_11_21$sentiment[DF_2015_11_21$sentiment < 0] <- "0"
DF_2015_11_21$sentiment[DF_2015_11_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2015_11_21)
...
scores <- score.sentiment(DF_2015_10_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2015_10_21$sentiment[DF_2015_10_21$sentiment < 0] <- "0"
DF_2015_10_21$sentiment[DF_2015_10_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2015_10_21)
...
scores <- score.sentiment(DF_2015_9_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2015_9_21$sentiment[DF_2015_9_21$sentiment < 0] <- "0"
DF_2015_9_21$sentiment[DF_2015_9_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2015_9_21)
...
scores <- score.sentiment(DF_2015_8_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2015_8_21$sentiment[DF_2015_8_21$sentiment < 0] <- "0"
DF_2015_8_21$sentiment[DF_2015_8_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2015_8_21)
...
scores <- score.sentiment(DF_2015_7_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2015_7_21$sentiment[DF_2015_7_21$sentiment < 0] <- "0"
DF_2015_7_21$sentiment[DF_2015_7_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2015_7_21)
...
scores <- score.sentiment(DF_2015_6_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2015_6_21$sentiment[DF_2015_6_21$sentiment < 0] <- "0"
DF_2015_6_21$sentiment[DF_2015_6_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2015_6_21)
...
scores <- score.sentiment(DF_2015_5_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2015_5_21$sentiment[DF_2015_5_21$sentiment < 0] <- "0"
DF_2015_5_21$sentiment[DF_2015_5_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2015_5_21)
...
scores <- score.sentiment(DF_2015_4_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2015_4_21$sentiment[DF_2015_4_21$sentiment < 0] <- "0"
DF_2015_4_21$sentiment[DF_2015_4_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2015_4_21)
...
scores <- score.sentiment(DF_2015_3_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2015_3_21$sentiment[DF_2015_3_21$sentiment < 0] <- "0"
DF_2015_3_21$sentiment[DF_2015_3_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2015_3_21)
...
scores <- score.sentiment(DF_2015_2_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2015_2_21$sentiment[DF_2015_2_21$sentiment < 0] <- "0"
DF_2015_2_21$sentiment[DF_2015_2_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2015_2_21)
...
scores <- score.sentiment(DF_2015_1_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2015_1_21$sentiment[DF_2015_1_21$sentiment < 0] <- "0"
DF_2015_1_21$sentiment[DF_2015_1_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2015_1_21)
...
scores <- score.sentiment(DF_2014_12_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2014_12_21$sentiment[DF_2014_12_21$sentiment < 0] <- "0"
DF_2014_12_21$sentiment[DF_2014_12_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2014_12_21)
...
scores <- score.sentiment(DF_2014_11_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2014_11_21$sentiment[DF_2014_11_21$sentiment < 0] <- "0"
DF_2014_11_21$sentiment[DF_2014_11_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2014_11_21)
...
scores <- score.sentiment(DF_2014_10_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2014_10_21$sentiment[DF_2014_10_21$sentiment < 0] <- "0"
DF_2014_10_21$sentiment[DF_2014_10_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2014_10_21)
...
scores <- score.sentiment(DF_2014_9_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2014_9_21$sentiment[DF_2014_9_21$sentiment < 0] <- "0"
DF_2014_9_21$sentiment[DF_2014_9_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2014_9_21)
...
scores <- score.sentiment(DF_2014_8_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2014_8_21$sentiment[DF_2014_8_21$sentiment < 0] <- "0"
DF_2014_8_21$sentiment[DF_2014_8_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2014_8_21)
...
scores <- score.sentiment(DF_2014_7_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2014_7_21$sentiment[DF_2014_7_21$sentiment < 0] <- "0"
DF_2014_7_21$sentiment[DF_2014_7_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2014_7_21)
...
scores <- score.sentiment(DF_2014_6_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2014_6_21$sentiment[DF_2014_6_21$sentiment < 0] <- "0"
DF_2014_6_21$sentiment[DF_2014_6_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2014_6_21)
...
scores <- score.sentiment(DF_2014_5_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2014_5_21$sentiment[DF_2014_5_21$sentiment < 0] <- "0"
DF_2014_5_21$sentiment[DF_2014_5_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2014_5_21)
...
scores <- score.sentiment(DF_2014_4_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2014_4_21$sentiment[DF_2014_4_21$sentiment < 0] <- "0"
DF_2014_4_21$sentiment[DF_2014_4_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2014_4_21)
...
scores <- score.sentiment(DF_2014_3_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2014_3_21$sentiment[DF_2014_3_21$sentiment < 0] <- "0"
DF_2014_3_21$sentiment[DF_2014_3_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2014_3_21)
...
scores <- score.sentiment(DF_2014_2_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2014_2_21$sentiment[DF_2014_2_21$sentiment < 0] <- "0"
DF_2014_2_21$sentiment[DF_2014_2_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2014_2_21)
...
scores <- score.sentiment(DF_2014_1_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2014_1_21$sentiment[DF_2014_1_21$sentiment < 0] <- "0"
DF_2014_1_21$sentiment[DF_2014_1_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2014_1_21)
...
scores <- score.sentiment(DF_2013_12_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2013_12_21$sentiment[DF_2013_12_21$sentiment < 0] <- "0"
DF_2013_12_21$sentiment[DF_2013_12_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2013_12_21)
...
scores <- score.sentiment(DF_2013_11_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2013_11_21$sentiment[DF_2013_11_21$sentiment < 0] <- "0"
DF_2013_11_21$sentiment[DF_2013_11_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2013_11_21)
...
scores <- score.sentiment(DF_2013_10_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2013_10_21$sentiment[DF_2013_10_21$sentiment < 0] <- "0"
DF_2013_10_21$sentiment[DF_2013_10_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2013_10_21)
...
scores <- score.sentiment(DF_2013_9_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2013_9_21$sentiment[DF_2013_9_21$sentiment < 0] <- "0"
DF_2013_9_21$sentiment[DF_2013_9_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2013_9_21)
...
scores <- score.sentiment(DF_2013_8_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2013_8_21$sentiment[DF_2013_8_21$sentiment < 0] <- "0"
DF_2013_8_21$sentiment[DF_2013_8_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2013_8_21)
...
scores <- score.sentiment(DF_2013_7_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2013_7_21$sentiment[DF_2013_7_21$sentiment < 0] <- "0"
DF_2013_7_21$sentiment[DF_2013_7_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2013_7_21)
...
scores <- score.sentiment(DF_2013_6_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2013_6_21$sentiment[DF_2013_6_21$sentiment < 0] <- "0"
DF_2013_6_21$sentiment[DF_2013_6_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2013_6_21)
...
scores <- score.sentiment(DF_2013_5_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2013_5_21$sentiment[DF_2013_5_21$sentiment < 0] <- "0"
DF_2013_5_21$sentiment[DF_2013_5_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2013_5_21)
...
scores <- score.sentiment(DF_2013_4_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2013_4_21$sentiment[DF_2013_4_21$sentiment < 0] <- "0"
DF_2013_4_21$sentiment[DF_2013_4_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2013_4_21)
...
scores <- score.sentiment(DF_2013_3_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2013_3_21$sentiment[DF_2013_3_21$sentiment < 0] <- "0"
DF_2013_3_21$sentiment[DF_2013_3_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2013_3_21)
...
scores <- score.sentiment(DF_2013_2_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2013_2_21$sentiment[DF_2013_2_21$sentiment < 0] <- "0"
DF_2013_2_21$sentiment[DF_2013_2_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2013_2_21)
...
scores <- score.sentiment(DF_2013_1_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2013_1_21$sentiment[DF_2013_1_21$sentiment < 0] <- "0"
DF_2013_1_21$sentiment[DF_2013_1_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2013_1_21)
...
scores <- score.sentiment(DF_2012_12_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2012_12_21$sentiment[DF_2012_12_21$sentiment < 0] <- "0"
DF_2012_12_21$sentiment[DF_2012_12_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2012_12_21)
...
scores <- score.sentiment(DF_2012_11_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2012_11_21$sentiment[DF_2012_11_21$sentiment < 0] <- "0"
DF_2012_11_21$sentiment[DF_2012_11_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2012_11_21)
...
scores <- score.sentiment(DF_2012_10_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2012_10_21$sentiment[DF_2012_10_21$sentiment < 0] <- "0"
DF_2012_10_21$sentiment[DF_2012_10_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2012_10_21)
...
scores <- score.sentiment(DF_2012_9_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2012_9_21$sentiment[DF_2012_9_21$sentiment < 0] <- "0"
DF_2012_9_21$sentiment[DF_2012_9_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2012_9_21)
...
scores <- score.sentiment(DF_2012_8_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2012_8_21$sentiment[DF_2012_8_21$sentiment < 0] <- "0"
DF_2012_8_21$sentiment[DF_2012_8_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2012_8_21)
...
scores <- score.sentiment(DF_2012_7_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2012_7_21$sentiment[DF_2012_7_21$sentiment < 0] <- "0"
DF_2012_7_21$sentiment[DF_2012_7_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2012_7_21)
...
scores <- score.sentiment(DF_2012_6_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2012_6_21$sentiment[DF_2012_6_21$sentiment < 0] <- "0"
DF_2012_6_21$sentiment[DF_2012_6_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2012_6_21)
...
scores <- score.sentiment(DF_2012_5_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2012_5_21$sentiment[DF_2012_5_21$sentiment < 0] <- "0"
DF_2012_5_21$sentiment[DF_2012_5_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2012_5_21)
...
scores <- score.sentiment(DF_2012_4_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2012_4_21$sentiment[DF_2012_4_21$sentiment < 0] <- "0"
DF_2012_4_21$sentiment[DF_2012_4_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2012_4_21)
...
scores <- score.sentiment(DF_2012_3_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2012_3_21$sentiment[DF_2012_3_21$sentiment < 0] <- "0"
DF_2012_3_21$sentiment[DF_2012_3_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2012_3_21)
...
scores <- score.sentiment(DF_2012_2_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2012_2_21$sentiment[DF_2012_2_21$sentiment < 0] <- "0"
DF_2012_2_21$sentiment[DF_2012_2_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2012_2_21)
...
scores <- score.sentiment(DF_2012_1_21_cleanREG$text,  pos.words, neg.words, .progress='text')
...
DF_2012_1_21$sentiment[DF_2012_1_21$sentiment < 0] <- "0"
DF_2012_1_21$sentiment[DF_2012_1_21$sentiment > 0] <- "1"
...
results21L2F <- rbind(results21L2F, results2012_1_21)

rm(DF_2012_1_21_cleanREG, scores, DF_2012_1_21, date, tots, negs, poss, results2012_1_21)

save(results21L2F, file = "Objects/Models/results21L2F.RData")
